        ...
        <div style="" class="col-lg-7 m-auto p-0">
              <div class="card bg-transparent p-3 border-0"  style="height: 90vh;display: grid;place-items: center;">
                <form style="margin: auto;width: 400px;max-width: 100%;border: 1px solid rgba(0, 0, 0, 0.2);padding: 20px;border-radius: 10px;" method="POST" action="../controller/loginController.php">
                  <h1 class="title_signin mt-4" style="color: #0d528a;text-align: center;"><img src="../images/logo.png" width="150px"> Log In</h1>
               <!--    <h3>Hello</h3>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-control pl-2 pr-2 p-0 d-flex" style="place-items:center;border: 2px solid rgba(0, 0, 0, 0.2);border-radius: 8px;">
                      <input type="text" name="emailemployeeid" id="email" placeholder="Email/Employee ID" class="rounded w-100 h-100 border-0 bg-transparent" style="outline: none;">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="form-control p-0 border-0">
                      <input type="submit" name="login" class="signin btn-lg text-white w-100 border-0" value="Login" style="outline: none;background-color: #0000FF;border-radius: 8px;" onclick="lsRememberMe()">
                    </div>
                    <br>
