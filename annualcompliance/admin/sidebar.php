...
<aside class="main-sidebar" style="overflow-y: auto;bottom: 0;">
  <section class="sidebar">
    <ul class="sidebar-menu" data-widget="tree">
      <li class="header" style="background-color: #fff;color: lightblue;text-align: center;font-size: 26px;padding-bottom: 20px;">
        <img src="../images/logo.png" width="130px">
        <h3 style="font-weight: bold;margin: unset;color: #003067;">Annual Compliance</h3>
      </li>
      ...
      <?php if($_SESSION['type'] != 1){ ?>
        <li><a href="compliance.php"><i class="fas fa-list"></i> <span> 
          <?php
          if ($_SESSION['type'] == 0) {
            echo "Compliance";
          } else {
      ...
      <?php if ($_SESSION['type'] == 2) { ?>
        <li><a href="users.php"><i class="fas fa-users"></i> <span> Account Employee</span></a></li>
      <?php } ?>
