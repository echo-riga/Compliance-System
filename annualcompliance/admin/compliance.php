                        ...
                        <table id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['category'])) {
                                    if ($_SESSION['type'] == 2) {
                                        $sql = "SELECT *,compliance.status AS c_status FROM compliance INNER JOIN users ON compliance.users_id=users.users_id WHERE compliance.status = 'Approved' AND compliance.category = '".$_GET['category']."'";
